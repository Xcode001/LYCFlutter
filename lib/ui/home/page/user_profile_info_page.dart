...
import 'package:flutter_lyc/main.dart';
...
import 'package:flutter_lyc/ui/home/page/location_list_page.dart';
import 'package:flutter_lyc/ui/home/presenter/profile_info_presenter.dart';
import 'package:flutter_lyc/ui/home/contract/profile_info_contract.dart';
...
class UserProfileInfoPageState extends State<UserProfileInfoPage>
    ...
    await showDialog(
        ...
        builder: (BuildContext context) {
          return new SimpleDialog(
            ...
            children: <Widget>[
              new Padding(
                padding: const EdgeInsets.only(left: MyStyle.double20, top: MyStyle.double20),
  ...
  Widget getGenderDropDownButton() {
    return new Container(
      padding: const EdgeInsets.only(left: MyStyle.double10, right: MyStyle.double20),
        ...
        child: new DropdownButton(
            ...
            items: genderData.map((String value) {
              return new DropdownMenuItem<String>(
                  value: value,
                  child: new Padding(
                    padding: const EdgeInsets.only(left: MyStyle.double10),
  ...
  Widget getLocationDropDownButton() {
    return new Container(
        height: 45.0,
        padding: const EdgeInsets.only(left: MyStyle.double10, right: MyStyle.double10),
        decoration: new BoxDecoration(color: MyStyle.layoutBackground),
        child: new Stack(
          children: <Widget>[
            new Align(
            ...
            children: <Widget>[
              new Container(
                ...
                margin: const EdgeInsets.only(
                    left: MyStyle.double10, right: MyStyle.double10, top: MyStyle.double64, bottom: MyStyle.double32),
                padding:
                    const EdgeInsets.only(left: MyStyle.double10, right:  MyStyle.double10, top:  MyStyle.double64),
                child: new ListView(
                    shrinkWrap: true,
                    controller: new ScrollController(),
                    children: <Widget>[
                      new Padding(
                        padding: const EdgeInsets.symmetric(vertical:  MyStyle.double10),
                      ...
                      new InkWell(
                        child: new Container(
                            height: 45.0,
                            padding:
                                const EdgeInsets.only(left:  MyStyle.double10, right:  MyStyle.double10),
                            decoration: new BoxDecoration(
                                color: MyStyle.layoutBackground),
                            child: new Align(
                                alignment: FractionalOffset.centerLeft,
