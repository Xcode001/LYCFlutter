...
import 'package:flutter_lyc/ui/login/presenter/login_presenter.dart';
      ...
      child: new Column(
        children: <Widget>[
          new Text(
            ...
            style: new TextStyle(
                fontSize: MyStyle.font14, color: MyStyle.colorBlack),
  ...
  void saveDataToPrefs(Account a) {
    setState(() {
      ...
      sharedPreferences.putStringData(
          Configs.PREF_USER_ACCESS_CODE, account.accessCode);
