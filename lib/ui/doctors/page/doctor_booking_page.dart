...
import 'package:flutter_lyc/ui/doctors/presenter/doctor_booking_presenter.dart';
import 'package:flutter_lyc/ui/doctors/contract/doctor_booking_contract.dart';
...
class DoctorBookingPageState extends State<DoctorBookingPage>
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Padding(
            padding: const EdgeInsets.only(left: MyStyle.double8, right: MyStyle.double8),
            child: new Divider(
              height: 2.0,
          ...
          new Padding(
            padding:
                const EdgeInsets.symmetric(horizontal:MyStyle.double12, vertical: MyStyle.double4),
            child: new Text(
              office,
              textAlign: TextAlign.left,
  ...
  _roundShapeContainer(String data) {
    return new Container(
      alignment: FractionalOffset.centerRight,
      padding: const EdgeInsets.symmetric(horizontal: MyStyle.double12, vertical: MyStyle.double4),
      width: 120.0,
      height: 40.0,
      child: new Center(
        child: new Text(
  ...
  _scheduleWidgetItems(bool status, String title, String subTitle) {
    ...
    return new Padding(
        padding: const EdgeInsets.only(top:MyStyle.double4, bottom: MyStyle.double4, left: MyStyle.double4),
        child: new Row(
          ...
          children: <Widget>[
            ...
            new Column(
              ...
              children: <Widget>[
                new Text(title,
                    style: new TextStyle(fontSize: MyStyle.font12, color: mColor),
                    textAlign: TextAlign.center),
                new Container(
                  height: 6.0,
                  child: null,
  ...
  Widget _requestBookingButton() {
    return new Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
      new Expanded(
        ...
        padding: const EdgeInsets.only(top: MyStyle.double16, bottom: MyStyle.double16),
        child: new Text(
          'REQUEST BOOKING NOW',
          style: MyStyle.buttonTextStyle(),
        ),
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text(
          ...
          style: new TextStyle(color: MyStyle.colorBlack, fontSize: MyStyle.font14),
        ),
      ),
      body: new Container(
        child: new SingleChildScrollView(
          ...
          child: new Column(
            children: <Widget>[
              new Center(
                child: new Padding(
                    padding: const EdgeInsets.only(top: MyStyle.double10, bottom: MyStyle.double10),
