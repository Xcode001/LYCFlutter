...
import 'package:flutter_lyc/ui/comment/widget/comment_reply_item_widget.dart';
import 'package:flutter_lyc/ui/comment/contract/comment_reply_contract.dart';
import 'package:flutter_lyc/ui/comment/presenter/comment_reply_presenter.dart';
import 'package:flutter_lyc/ui/otheruser/page/other_user_page.dart';
...
class CommentReplyDialogPageState extends State<CommentReplyDialogPage>
                    ...
                    new Padding(
                      ...
                      child: new Row(
                        ...
                        children: <Widget>[
                          ...
                          new Padding(
                              padding:
                                  const EdgeInsets.only(left: MyStyle.double4, right: MyStyle.double4),
                              child: new Text('.',
                                  style: new TextStyle(
  ...
  Widget _buildTextComposer() {
    return new IconTheme(
        ...
        child: new Container(
            margin: const EdgeInsets.symmetric(horizontal: MyStyle.double8),
            ...
            children: <Widget>[
              ...
              new Flexible(
                child: new ListView.builder(
                  padding: const EdgeInsets.only(left: MyStyle.double24),
