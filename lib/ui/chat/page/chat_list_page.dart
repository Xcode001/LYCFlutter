...
import 'package:flutter_lyc/ui/chat/contract/chat_contract.dart';
import 'package:flutter_lyc/ui/chat/presenter/chat_presenter.dart';
...
class ChatListPageState extends State<ChatListPage>
  ...
  void getAccessCode(bool login) {
    if (login) {
      isGuest = false;
      mySharedPreferences.getStringData(Configs.PREF_USER_ACCESS_CODE).then((v) {
        accessCode = v;
        connect();
